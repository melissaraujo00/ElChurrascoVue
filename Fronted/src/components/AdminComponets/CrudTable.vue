  ...
  <div class="p-6 text-gray-900">
    <div class="relative overflow-x-auto shadow-xl rounded-2xl bg-gray-300 max-w-[108rem] mx-auto p-2 m-2">
      ...
      <div class="bg-gray-300 p-4 shadow-inner rounded-b-2xl max-w-7xl mx-auto">
        <table class="w-full text-sm text-left text-gray-900 border border-gray-600 rounded-2xl overflow-hidden shadow-2xl">
            ...
            >
              ...
              <td class="px-5 py-3">
                <div class="flex gap-2">
                  <button
                    @click="editItem(item)"
                    class="text-white bg-orange-600 hover:bg-orange-700 font-medium text-sm rounded-md px-5 py-1.5 shadow-md border-2 border-orange-500"
                  >
                    Editar
                  </button>
                  <button
                    ...
                    class="text-white bg-red-600 hover:bg-red-700 font-medium text-sm rounded-md px-5 py-1.5 shadow-md border-2 border-red-500"
                  >
                    Eliminar
                  </button>
                </div>
